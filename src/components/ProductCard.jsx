  ...
  return (
    <Link to={`/product/${prod.id}`}>
      <div class={`m-5 rounded-md hover:shadow-lg duration-300 ${darkMode ? 'bg-gray-900 hover:bg-gray-800 text-white' : 'bg-gray-100 hover:bg-gray-200'}`}>
          <img src={`${prod.img}`} alt="footlocker" class="lg:rotate-45 h-auto p-5" />
          <div class="flex flex-col justify-center align-middle">
          <p class=" text-xl text-center mb-5 font-black">{prod.productName}</p>
          <p class="text-4xl font-black text-center"><span>${prod.price}</span></p>
