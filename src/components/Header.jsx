...
const Header = () => {
  ...
  return (
    <div className={`p-20 pt-40 flex flex-row  justify-evenly duration-300 ${darkMode ? "bg-black text-white" : "bg-white text-black"}`}>
        <div className={`rounded-full flex justify-center align-middle duration-300 ${darkMode ? "bg-white" : "bg-black"}`}>
            <img src={`../images/${selectedImage}`} className=' rotate-45' alt="" />
        </div>
